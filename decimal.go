...
// RoundUp rounds away from zero to the specified prec (shopspring RoundUp).
...
// RoundDown rounds toward zero to the specified prec (shopspring RoundDown).
...
// Trunc is an alias for RoundDown.
func (d Decimal) Trunc(prec uint8) Decimal {
	return d.RoundDown(prec)
}
